...
namespace GradeSystem.Data
{
    public partial class GradeSystemContext : DbContext
    {
        ...
        internal Task<IActionResult> ToListAsync()
        {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=localhost,1432;Initial Catalog=GradeKeeper;Persist Security Info=True;User ID=sa;Password=!2E45678");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Grades>(entity =>
            {
                ...
                entity.Property(e => e.Grade).HasMaxLength(25);
